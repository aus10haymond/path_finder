...
- **[2026-05-19] Google Maps links started from stop #1 instead of start address** — `start_address`/`end_address` now included in job result; prepended/appended to first/last Maps segment URL in both frontend and email
